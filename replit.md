...
- **Permisos de menú**: `client/src/config/menuModules.ts` define los módulos controlables por permisos. Incluye `deshacer_operaciones`. FloatingMenu verifica `hasMenuAccess()` antes de mostrar el botón.
