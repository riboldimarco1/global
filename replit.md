...
- mammoth — reads .docx files client-side for DocxSummaryDialog (Herramientas → Resumen validación caña) extracting "Total Caña", and DocxZafraSummaryDialog (Herramientas → Resumen hacienda zafra) extracting Toneladas Netas from ZAFRA column in Portuguesa reports.
- Node.js
- Express.js
- Drizzle ORM