...
- mammoth — reads .docx files client-side for DocxSummaryDialog (Herramientas → Resumen validación caña), extracting "Total Caña" from Portuguesa liquidation reports.
- Node.js
- Express.js
- Drizzle ORM