...
import { pgTable, serial, text, varchar, real, boolean, date, integer, timestamp, numeric, jsonb, index, uniqueIndex } from "drizzle-orm/pg-core";
...
export const transferencias = pgTable("transferencias", {
  ...
  contbanco: boolean("contbanco"),
  contadmin: boolean("contadmin"),
...
export const portal = pgTable("portal", {
  ...
  nombre: varchar("nombre"),
  cedula: varchar("cedula"),
  bancofuente: varchar("bancofuente"),
