...
import { Loader2, Tag, Home, Box } from "lucide-react";

const categoriasColumns: Column[] = [
...
const suministrosColumns: Column[] = [
  { key: "habilitado", label: "H", defaultWidth: 32, type: "boolean", align: "center" },
  { key: "nombre", label: "Nombre", defaultWidth: 200, type: "text" },
  { key: "unidad", label: "Unidad", defaultWidth: 120, type: "text" },
...
export default function AlmacenParametros({ unidadFilter }: { unidadFilter: string }) {
  ...
  return (
    <MySubTabs
      ...
      testIdPrefix="tab-almacen-param"
    >
      <MyGrid
        key={`almacen-param-${activeTab}`}
        tableId={`almacen-param-${activeTab}`}
