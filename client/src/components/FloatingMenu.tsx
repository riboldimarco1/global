...
export type ModuleKey = "parametros" | "administracion" | "bancos" | "cosecha" | "almacen" | "arrime" | "transferencias" | "cheques" | "agrodata" | "reportes" | "debug";
...
const modules: { key: ModuleKey; label: string; icon: JSX.Element; color: string }[] = [
  ...
  { key: "agrodata", label: "Agrodata", icon: <HardDrive className="h-4 w-4" />, color: "text-cyan-500" },
