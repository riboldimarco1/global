...
export type ModuleKey = "parametros" | "administracion" | "bancos" | "cosecha" | "almacen" | "arrime" | "transferencias" | "cheques" | "reportes" | "agrodata" | "agronomia" | "reparaciones" | "bitacora" | "debug";
...
const moduleStyles: Record<string, ModuleStyle> = {
  ...
  cheques: { icon: <FileText className="h-5 w-5 text-white" />, bgColor: "bg-indigo-600", bgColorAlegre: "bg-gradient-to-b from-indigo-500 to-indigo-700", borderColor: "border-indigo-800", shadow3d: "shadow-[0_3px_0_0_rgb(49,46,129)]", textColor: "text-indigo-800 dark:text-indigo-300" },
